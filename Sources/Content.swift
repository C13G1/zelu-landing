...
let faqs: [(q: String, a: String)] = [
    ...
    ("Posso separar meus amigos em grupos?",
     "Sim! Por exemplo: faculdade, trabalho ou infância, e o app mostra como está cada grupo. O primeiro grupo é gratuito para você testar; os demais são liberados com uma única compra de R$ 9,90 dentro do app. O resto do Zelu é gratuito."),
    ...
    ("O Zelu já está disponível?",
     "Sim! O Zelu já está na App Store — toque em Baixe agora para baixar."),
